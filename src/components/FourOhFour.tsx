  ...
  return (
    <div className="my-12">
      ...
      <div className="mx-auto mt-6 max-w-xl text-gray-500">
        <div className="mb-8 text-xl font-bold text-gray-700 dark:text-gray-300">
          Something went wrong
        </div>
        <div className="mb-4 overflow-hidden break-all rounded border border-gray-400/20 bg-gray-50 p-3 font-mono text-xs dark:bg-gray-800">
          {errorMsg}
        </div>
        <div className="text-sm">
          <Trans>
            ...
            <a
              ...
              href="https://github.com/Astear17/VercelDrive/issues"
              target="_blank"
              rel="noopener noreferrer"
            >
              VercelDrive issues site
            </a>
            .
          </Trans>
        </div>
